...
WORKING_DIR="${BASE_DIR}/data/outputs/sc_rna_filter"
...
WORKING_DIR="${BASE_DIR}/data/outputs/sc_rna_reduce"
mkdir -p $WORKING_DIR && cd $WORKING_DIR
...
WORKING_DIR="${BASE_DIR}/data/outputs/sc_rna_cluster"
mkdir -p $WORKING_DIR && cd $WORKING_DIR
...
WORKING_DIR="${BASE_DIR}/data/outputs/sc_ctype_assign"
mkdir -p $WORKING_DIR && cd $WORKING_DIR
...
WORKING_DIR="${BASE_DIR}/data/outputs/sc_rna_de_pseudobulk"
mkdir -p $WORKING_DIR && cd $WORKING_DIR
...
WORKING_DIR="${BASE_DIR}/data/outputs/sc_rna_da_cells"
mkdir -p $WORKING_DIR && cd $WORKING_DIR
